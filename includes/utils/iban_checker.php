...
/**
 * IBAN-Validierung (angepasst aus deinem Krenge-Plugin)
 */
if (!function_exists('eeg_verw_check_iban')) {
    function eeg_verw_check_iban(string $iban): bool
    {
        if (strlen($iban) < 5) {
            return false;
        }
        ...
        // Modulo 97 – mit Fallback, falls bcmath nicht verfügbar
