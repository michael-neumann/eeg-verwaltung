...
function eeg_verw_admin_mitgliedsarten_page() {
    ...
    <div class="wrap">
        ...
        <a href="<?php echo esc_url(add_query_arg(['page' => 'eeg-mitgliedsarten', 'action' => 'new'], admin_url('admin.php'))); ?>" class="page-title-action">Neu</a>
            ...
            <form method="post">
                ...
                <table class="form-table" role="presentation">
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input name="sort_order" type="number" id="sort_order" class="small-text" min="0" step="1"
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input name="eeg_faktura_tarif_bezug" type="text" id="eeg_faktura_tarif_bezug" class="regular-text"
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input name="eeg_faktura_tarif_einspeisung" type="text" id="eeg_faktura_tarif_einspeisung" class="regular-text"
                    ...
                    <tr>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" name="aktiv" id="aktiv" <?php checked($is_edit ? (int) $edit_item->aktiv : 1, 1); ?>>
                                sichtbar/auswählbar
                            </label>
                        </td>
                    </tr>
                ...
                <?php if ($items): foreach ($items as $row): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="button button-small" href="<?php echo esc_url(add_query_arg(['page'=>'eeg-mitgliedsarten','action'=>'edit','id'=>$row->id], admin_url('admin.php'))); ?>">Bearbeiten</a>
