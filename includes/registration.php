...
function eeg_verw_register_shortcode($atts = [])
{
    ...
    if (isset($_POST['eeg_verw_reg_nonce']) && wp_verify_nonce($_POST['eeg_verw_reg_nonce'], 'eeg_verw_reg')) {
        $mitgliedsart_id = isset($_POST['user_id']) ? intval($_POST['user_id']) : 0;
        ...
        $uid = sanitize_text_field($_POST['user_id'] ?? '');
    ...
    <form method="post">
        ...
        <p>
            <label><?php echo esc_html__('Mitgliedsart', 'eeg-verwaltung'); ?><br>
                <input type="text" name="mitgliedsart" value="<?php echo esc_attr($_POST['mitgliedsart'] ?? ''); ?>"
                       required>
            </label>
        </p>
        <p>
        ...
        <p>
            <label><?php echo esc_html__('E-Mail-Adresse', 'eeg-verwaltung'); ?><br>
                <input type="email" name="user_email" value="<?php echo esc_attr($_POST['user_email'] ?? ''); ?>"
                       required>
            </label>
        </p>
        <p>
            <label><?php echo esc_html__('Telefon', 'eeg-verwaltung'); ?><br>
                <input type="text" name="telefon" value="<?php echo esc_attr($_POST['telefon'] ?? ''); ?>">
            </label>
        </p>
        <p>
        ...
        <p>
            <label><?php echo esc_html__('Zusatzfeld', 'eeg-verwaltung'); ?><br>
                <input type="text" name="eeg_custom_field"
                       value="<?php echo esc_attr($_POST['eeg_custom_field'] ?? ''); ?>">
            </label>
        </p>
        <p>
            <label>
